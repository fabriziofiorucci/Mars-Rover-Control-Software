...
public class SecurityFilter implements ContainerRequestFilter
{
	...
	private static final String REALM = "Rover REST API";
	...
	private User authenticate(ContainerRequestContext filterContext)
	{
		...
		String authentication = filterContext
		...
		if (username.equals(Configuration.get("rest_username"))
				&& password.equals(Configuration.get("rest_password")))
		{
